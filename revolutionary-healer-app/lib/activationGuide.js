// Rachael's RH Activation Guide -- reference material for the chatbot's
// ACTIVATION RECOMMENDATION coaching mode (see lib/prompts.js).
//
// This is Rachael's own guide to what each activation is for, when to use
// it, and specific notes on when the AI should (and should not) recommend
// it. This file will grow over time as Rachael sends more activations to
// document -- treat it as a living reference, not a fixed list. Only
// recommend an activation from here when the ACTIVATION RECOMMENDATION mode
// criteria in prompts.js are actually met -- never as a catch-all response
// to every hard feeling.

export const ACTIVATION_GUIDE = `
=== RH ACTIVATION GUIDE ===

GROUNDING + PROTECTION

Grounding Activation
What this activation is for: Use this activation when your energy feels
scattered, ungrounded, or when you need to get back into your body. When
you've been living ten steps ahead in your head, or you've been moving so
quickly that you barely feel connected to yourself anymore. It brings your
energy back into the present so you can work with what is actually happening
instead of everything your mind is running ahead to.
When to use this: You've been working, creating, talking to people or moving
all day and feel scattered. You're struggling to focus on one thing. You've
been doing a lot of energetic or spiritual work and want to come back into
your body. You feel like you are getting sick, or feel like you are
disconnected. You're about to make a decision but feel mentally everywhere.
You feel disconnected from yourself or your physical surroundings. Before or
after client work when you want to come back to your own energy. Before bed
after a busy day.
AI recommendation notes: Recommend when the user describes scattered
attention, mentally racing, difficulty being present, feeling energetically
"everywhere," feels like they may be getting sick, needing to come back to
herself. Prioritize this over deeper work when the user is tired, depleted,
overstimulated or specifically asks for something gentle/short. Do not use
Grounding as a catch-all answer to every emotion.

Protection & Shielding Activation
What this activation is for: Use this when you are naturally sensitive to
other people's energy and want to stay connected to yourself without shutting
down your sensitivity. This activation supports stronger energetic boundaries
and energetic hygiene so other people's emotions, expectations and energy do
not become indistinguishable from your own.
When to use this: Before client sessions. Before entering a busy or
emotionally intense environment. Before doing any energetic work on yourself
or someone else. Before large events, gatherings or family situations. When
you want to remain open without absorbing everything around you. If you
identify with being an empath this will assist you in not absorbing other
peoples energies. Before bed after a busy day.
AI recommendation notes: Recommend when the user specifically describes
picking up, absorbing or carrying energy from other people/environments. Do
not assume another person's energy is responsible simply because the user
feels bad.

10 Min Earth Star Activation
What this activation is for: A shorter grounding practice focused
specifically on the Earth Star Chakra about 5 feet beneath the feet, located
outside of the body. Use this when you are experiencing a lot of collective
energies, generational patterns or are carrying ancestral frequencies that
are not yours. This is an amazing activation to do after you have raised your
vibration or activated your light body, as the Earth Star Chakra is
responsible for grounding the more expanded parts of your energy.
When to use this: Before spiritual or intuitive work. After feeling very "up
in the ethers." When you want a quick energetic grounding before starting
your day. After client sessions. When you have been doing a lot of
channeling, meditation or energetic work. When generational, ancestral and
collective shifts have been coming up for you.
AI recommendation notes: Useful as a shorter grounding recommendation,
particularly for spiritually sensitive users who describe feeling
disconnected from the physical world after energetic work. Also a good
activation to suggest to someone who has already done the Grounding
Activation.

CLEARING + RELEASE

Clearing Activation
What this activation is for: This is the broad, everyday clearing
activation. Use it when something feels energetically heavy, stagnant or
"off," but you do not necessarily know exactly what you picked up or where it
came from. This is a daily energetic hygiene practice to maintain your
frequency in purity.
When to use this: After a hard day. Before and/or after client work. After
conflict or an emotionally intense conversation. When you feel energetically
heavy without an obvious reason. When you want to clear before moving into
another activation. When something simply feels off and you want a general
reset.
AI recommendation notes: This should be one of the AI's most versatile
clearing recommendations. Do not invent a specific energetic cause when the
user has not identified one.

ENERGY + FREQUENCY

Pink Cloud Activation
What this activation is for: Use Pink Cloud when you have been sitting in
heavy energy for a while and want to deliberately work with lifting and
moving it rather than continuing to carry it around. If someone has been
carrying a lot -- work, relationships, finances, children, situations,
emotional energy -- this activation is to help them lift it all off,
returning them to their natural state. This will remove any unwanted
energies or energies that are not theirs.
When to use this: After several emotionally heavy days. When you feel weighed
down by an environment or situation. When you have been processing a lot and
want something more energetic than conversational. When someone has come out
of a chaotic situation and is ready to move forward. When someone is still
holding onto the past, stories or situations that are not serving them and
those experiences are still running in their field. When you want a broader
energetic lift rather than solving one specific issue. If someone is sick or
feeling unwell, or experiencing ascension symptoms, this will support them
(key word support, not fix, heal or cure).
AI recommendation notes: Good general energetic support when the user wants
to work with heaviness energetically. When the user is holding onto
emotional, physical, energetic, and mental overload.

Light Frequency Activation: Increase Your Light and Shine Like the Sun!
What this activation is for: Use this when you want to intentionally
increase the amount of light you are expressing through your energy, work
and presence rather than dimming yourself or disappearing into the
background. This will increase your radiance, energy, and aura.
When to use this: Before creating or sharing something. When you feel
energetically dimmed after being around heavy situations. Before client work.
When you are reconnecting with your presence. When you desire to have a
higher vibration. When you want to work with becoming more energetically
noticeable without forcing visibility.
AI recommendation notes: Good for light/presence/energetic
expression/frequency elevation. Do not make this interchangeable with
Visibility/Expansion Activation -- this is about energetic light; Expansion
Activation is more directly connected to being seen. This activation
supports visibility work but is not the same thing.

Lifting You Higher Activation: Raise Your Vibration Above The Matrix
Frequencies
What this activation is for: Use this when you feel caught inside collective
fear, noise, limitation or outside opinions and want to consciously
reconnect with a perspective that feels more like your own. If someone is
running a lot of fear frequencies this will lift them out of a fear
vibration and assist in bringing them back into a higher state.
When to use this: After doom-scrolling/news/social media overload. When
everyone around you seems afraid or negative and you can feel yourself
joining it. When collective conversations are affecting how you see what is
possible. When you want to separate your own perspective from the emotional
climate around you. When you want to unplug from the fear, scarcity, and
collective frequencies.
AI recommendation notes: Useful for collective-energy themes. Do not use
"matrix frequencies" as a universal explanation for real-world difficulties.

Sacred Bowl Activation
What this activation is for: A womb clearing to activate creation, birth and
balance feminine frequencies.
When to use this: When your creation energy feels slow. When you want to
clear past sexual partners and frequencies from your womb. To balance and
harmonize the feminine frequencies. When you desire to birth something new
into your reality.
